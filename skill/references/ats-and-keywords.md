...
1. **Extract the JD's outcomes + language:** what the role owns, the metrics it cares about (growth? platform? monetization?), the seniority signals (strategy, mentoring, 0→1), and the exact tool/keyword phrasing.
